...
def clean_dataframe(df):
    ...
    try:
        ...
        # slice the dataframe
        return df.iloc[:, [date_col, material_col, sales_col, qty_col]]
...
def condense_materials(clean_df):
  try:
    # import pandas
    import pandas as pd

    # Group by 'Material' and sum 'Invoiced Quantity' and 'NET SALES'
    condensed_df = clean_df.groupby("Material", as_index=False)[["Invoiced Quantity", "NET SALES"]].sum()
